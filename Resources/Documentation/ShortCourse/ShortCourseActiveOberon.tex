...
This section gives a brief overview of the most used I/O facilities.

\subsection{Streams}
Streams provide an abstraction to ressources that are accessed byte-wise. 

\subsection{Files}
The module Files is the interface implemented by file system drivers and the same time the A2 Files API.
...
The subsequent definitions are applicable to the A2 operating system for which SYSTEM is implemented directly in the compiler.
...
\begin{center}
    ...
    \begin{tabular}{|l|l|}
        ...
        \hline
        GET(adr : ADDRESS) : Type & RETURN Mem[adr] whereas the size of type x is 8, 16, 32 or 64 bits \\
        \hline
    ...
    \end{tabular}
    \caption{IA-32 Version Functions}
    \end{table}
\end{center}
